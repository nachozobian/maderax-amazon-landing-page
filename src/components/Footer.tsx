      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-3 gap-12 mb-16">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <a 
                  href="#" 
                  className="inline-flex items-center justify-center w-10 h-10 bg-slate-700 hover:bg-amber-500 text-slate-300 hover:text-black rounded-lg transition-all duration-300"
                >
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 backdrop-blur-sm border border-slate-600/50 rounded-xl p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-slate-300 font-light">Desktop organizer collection</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-amber-500 to-amber-600 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-slate-300 font-light">Kitchen storage solutions</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-amber-500 to-amber-600 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-slate-300 font-light">Bathroom organization systems</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-gradient-to-r from-amber-500 to-amber-600 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-slate-300 font-light">Custom storage accessories</span>
                  </div>
                </div>
              </div>
            </div>
