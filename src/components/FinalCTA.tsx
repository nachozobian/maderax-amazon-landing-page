...
const FinalCTA = () => {
  ...
  return (
    <section className="py-32 bg-gradient-to-b from-amber-100 to-orange-200 text-slate-900">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-12">
            <div className="space-y-8">
              <h2 className="text-5xl lg:text-6xl font-light tracking-tight text-slate-800">
                Ready to <span className="font-serif italic text-amber-600">complete</span><br />
                your space?
              </h2>
            ...
            <div className="space-y-6">
              <Button 
                ...
                size="lg"
                className="bg-slate-800 hover:bg-slate-700 text-white px-12 py-6 text-xl font-medium rounded-none transition-all duration-300 shadow-lg"
              >
                Shop on Amazon
